...
public class TNObject : MonoBehaviour
{
	...
	public void RFC (byte rfcID, Player target, params object[] objs) { SendRFC(id, rfcID, null, target, objs); }
	...
	static void SendRFC (int objID, byte rfcID, string rfcName, Player target, params object[] objs)
	{
		if (TNManager.isConnected)
		{
